...
SECRET_KEY = 'django-insecure-4%d*2_rg4_z_ym3gcxljbj84s3vqz_=uho=)lq$o&n9tsny(+m'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'arfigyelo.kapcsolat@gmail.com'
EMAIL_HOST_PASSWORD = 'jniu ovjk cfsm zmkj'  
